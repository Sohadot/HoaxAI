...
def validate_governance() -> bool:
    ...
    if pub.get("current_publisher_status") not in (
        ...
        error("publisher status must be blocked_until_public_reference_production_batch_3_validation, evidence_posture_standard_v1_validation, or protocol v1 draft validation")
        ok = False
    gate = next(
