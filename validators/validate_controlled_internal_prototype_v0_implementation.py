...
def validate_governance() -> bool:
    ...
    if policy.get("current_publisher_status") != PUBLISHER_STATUS_POST_CONTROLLED_INTERNAL_PROTOTYPE_V0_VALIDATION:
        error("publisher status must be blocked_until_controlled_internal_prototype_v0_validation")
        ok = False
