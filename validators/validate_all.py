...
VALIDATORS = [
    ...
    ROOT / "validators" / "validate_public_reference_external_use_integrity_audit_v1.py",
    ROOT / "validators" / "validate_public_reference_strategic_reviewer_surface_audit_v1.py",
    ...
    ROOT / "validators" / "validate_public_reference_non_transactional_revenue_boundary_audit_v1.py",
    ROOT / "validators" / "validate_public_reference_value_integrity_closure_audit_v1.py",
    ROOT / "validators" / "validate_public_release_indexation_integrity_audit_v1.py",
    ...
    ROOT / "validators" / "validate_live_deployment_freshness_recheck_audit_v1.py",
]
