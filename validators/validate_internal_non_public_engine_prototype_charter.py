...
def validate_governance() -> bool:
    ...
    if policy.get("current_publisher_status") != PUBLISHER_STATUS_POST_INTERNAL_NON_PUBLIC_ENGINE_PROTOTYPE_CHARTER:
        error("publisher status must be blocked_until_internal_non_public_engine_prototype_charter_validation")
        ok = False
