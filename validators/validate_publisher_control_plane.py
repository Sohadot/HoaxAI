...
REQUIRED_STATES = [
    ...
    "public_route_readiness_checked",
    "proposed_internal",
...
REQUIRED_GATE_IDS = [f"PUB-GATE-{i:04d}" for i in range(1, 120)]
...
def validate_publisher_policy() -> bool:
    ...
    if data.get("maturity") not in (
        ...
        "publisher_blocked_until_public_category_language_layer",
        "publisher_blocked_until_public_category_language_validation",
        "publisher_blocked_until_evidence_posture_workbench_governance",
        "publisher_blocked_until_evidence_posture_workbench_dry_run_harness",
        ...
        "publisher_blocked_until_public_route_candidate_registry_governance",
        "publisher_blocked_until_public_route_candidate_registry_governance_validation",
        "publisher_blocked_until_public_route_candidate_registration_governance",
        "publisher_blocked_until_public_route_candidate_registration_governance_validation",
        "publisher_blocked_until_public_route_candidate_registration_authorization_governance",
        "publisher_blocked_until_public_reference_production_batch_1",
        "publisher_blocked_until_public_reference_production_batch_1_validation",
        "publisher_blocked_until_public_reference_production_batch_2_validation",
        "publisher_blocked_until_public_reference_production_batch_3_validation",
        "publisher_blocked_until_evidence_posture_standard_v1_validation",
        "publisher_blocked_until_evidence_posture_protocol_v1_draft_validation",
        "publisher_blocked_until_public_interface_thesis_evidence_field_validation",
        ...
        "publisher_blocked_until_evidence_posture_engine_model_v0_validation",
        "publisher_blocked_until_output_language_guardrail_model_v1_validation",
        "publisher_blocked_until_internal_non_public_engine_prototype_charter_validation",
        "publisher_blocked_until_controlled_internal_prototype_v0_implementation_sprint",
        "publisher_blocked_until_controlled_internal_prototype_v0_validation",
        "publisher_blocked_until_controlled_internal_prototype_v0_hardening_validation",
    ):
